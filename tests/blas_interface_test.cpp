...
QudaBLASEngine blas_engine_type = QUDA_BLAS_ENGINE_CUBLAS;
int blas_batch = 16;
...
void setBLASParam(QudaBLASParam &blas_param) {
  ...
  blas_param.engine = blas_engine_type;
...
double gemm_test(test_t test_param) {
  ...
  blas_engine_type = ::testing::get<2>(test_param);
...
struct blas_interface_test : quda_test {
  ...
  void add_command_line_group(std::shared_ptr<GGPApp> app) const override
  {
    ...
    CLI::TransformPairs<QudaBLASOperation> blas_op_map {{"N", QUDA_BLAS_OP_N},
							{"T", QUDA_BLAS_OP_T},
							{"C", QUDA_BLAS_OP_C}};

    CLI::TransformPairs<QudaBLASEngine> blas_engine_map {{"cublas", QUDA_BLAS_ENGINE_CUBLAS},
    ...
    opgroup
      ...
      ->transform(CLI::GGPCheckedTransformer(blas_op_map));
...
int main(int argc, char **argv)
{
  ...
  if (enable_testing) {
    ...
    case QUDA_BLAS_GEMM: 
      switch (blas_engine_type) {
      case QUDA_BLAS_ENGINE_CUBLAS:
	switch (blas_data_type) {
	case QUDA_BLAS_DATATYPE_S: gemm_test(test_t {QUDA_BLAS_GEMM, QUDA_BLAS_DATATYPE_S, QUDA_BLAS_ENGINE_CUBLAS}); break;
	case QUDA_BLAS_DATATYPE_D: gemm_test(test_t {QUDA_BLAS_GEMM, QUDA_BLAS_DATATYPE_D, QUDA_BLAS_ENGINE_CUBLAS}); break;
	case QUDA_BLAS_DATATYPE_C: gemm_test(test_t {QUDA_BLAS_GEMM, QUDA_BLAS_DATATYPE_C, QUDA_BLAS_ENGINE_CUBLAS}); break;
	case QUDA_BLAS_DATATYPE_Z: gemm_test(test_t {QUDA_BLAS_GEMM, QUDA_BLAS_DATATYPE_Z, QUDA_BLAS_ENGINE_CUBLAS}); break;
	default: errorQuda("Undefined QUDA BLAS data type %d\n", blas_data_type);
	}
	break;
      case QUDA_BLAS_ENGINE_CUTLASS: 
	switch (blas_data_type) {
	case QUDA_BLAS_DATATYPE_S: gemm_test(test_t {QUDA_BLAS_GEMM, QUDA_BLAS_DATATYPE_S, QUDA_BLAS_ENGINE_CUTLASS}); break;
	case QUDA_BLAS_DATATYPE_D: gemm_test(test_t {QUDA_BLAS_GEMM, QUDA_BLAS_DATATYPE_D, QUDA_BLAS_ENGINE_CUTLASS}); break;
	case QUDA_BLAS_DATATYPE_C: gemm_test(test_t {QUDA_BLAS_GEMM, QUDA_BLAS_DATATYPE_C, QUDA_BLAS_ENGINE_CUTLASS}); break;
	case QUDA_BLAS_DATATYPE_Z: gemm_test(test_t {QUDA_BLAS_GEMM, QUDA_BLAS_DATATYPE_Z, QUDA_BLAS_ENGINE_CUTLASS}); break;
	default: errorQuda("Undefined QUDA BLAS data type %d\n", blas_data_type);
	}
	break;
      default: errorQuda("Unknown QUDA BLAS engine type %d", blas_engine_type);
      }
      break;
    case QUDA_BLAS_LU_INV: 
      switch (blas_data_type) {
      case QUDA_BLAS_DATATYPE_C: lu_inv_test(test_t {QUDA_BLAS_LU_INV, QUDA_BLAS_DATATYPE_C, QUDA_BLAS_ENGINE_CUBLAS}); break;
      case QUDA_BLAS_DATATYPE_Z: lu_inv_test(test_t {QUDA_BLAS_LU_INV, QUDA_BLAS_DATATYPE_Z, QUDA_BLAS_ENGINE_CUBLAS}); break;
